...
exports.mToken = exports.Token = exports.PositiveFiniteInteger = void 0;
...
exports.PositiveFiniteInteger = PositiveFiniteInteger;
class Token {
  value;
  denomination;
...
exports.Token = Token;
class mToken extends PositiveFiniteInteger {
  denomination;
  constructor(value, denomination) {
    super(value);
    this.denomination = +denomination;
